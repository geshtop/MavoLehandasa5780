...
public class SphereTests {
    ...
    public void testFindIntersections() {
		...
		List<Point3D> intersections = Arrays.asList(new Point3D( new Point3D(0, 0, 2)),
				new Point3D( new Point3D(-2, 0, 0)));
		...
		intersections = Arrays.asList(new Point3D( new Point3D(x, y, 0)));
		assertEquals("Sphere findIntersection error ", intersections,
		...
		intersections = Arrays.asList(new Point3D( new Point3D(-2, 0, 0)));
		assertEquals("Sphere findIntersection error ", intersections,
		...
		// diameter
		intersections = Arrays.asList(new Point3D( new Point3D(-2, 0, 0)),new Point3D(  new Point3D(2, 0, 0)));
		assertEquals("Sphere findIntersection error ", intersections,
				sphere.findIntersections(new Ray(new Point3D(3, 0, 0), new Vector(-1, 0, 0))));
